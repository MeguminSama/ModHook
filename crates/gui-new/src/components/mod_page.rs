...
use crate::{CONFIG, POPUP_STATE, PopupState, THEME, utils::hoverable::hoverable};
    ...
    rsx!(rect {
        ...
        rect {
            ...
            Button {
                ...
                onpress: move |_| {
                    let mod_path = discord_modloader::paths::config_mods_dir();
            ...
            rect {
                ...
                rect {
                    ...
                    Button {
                        ...
                        onpress: move |_| {
                            let _ = open::that(discord_modloader::paths::config_icons_dir());
                        },
            ...
            rect {
                ...
                rect {
                    ...
                    Dropdown {
                        ...
                        for i in discord_modloader::config::DistFileType::iter() {
                            DropdownItem {
                                value: i.to_string(),
...
#[component]
fn SaveButton(pending: bool, onclick: EventHandler<Event<MouseData>>) -> Element {
    let floppy_disk_icon = static_bytes(crate::assets::FLOPPY_DISK_ICON);

    let animation = hoverable!(move |_conf| {
        AnimColor::new(THEME.read().bg_primary, THEME.read().blurple)
            .ease(Ease::InOut)
            .time(100)
    });

    let bg_color = if pending {
        THEME.read().bg_success
    } else {
        &animation.animation.get().read().read()
    };
